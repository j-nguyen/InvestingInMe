//
//  EditProjectScreenshotCell.swift
//  InvestingInMe
//
...
public class EditProjectScreenshotCell: UITableViewCell {
  // MARK: PublishSubjects
  public let assets: PublishSubject<[URL]> = PublishSubject()
...
extension EditProjectScreenshotCell: UIScrollViewDelegate {
